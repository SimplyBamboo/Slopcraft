...
export default class GuiOptions extends GuiScreen {
    ...
    init() {
        ...
        this.buttonList.push(new GuiSliderButton("Render Distance", settings.viewDistance, 2, 128, this.width / 2 - 100, y + 24 * 3, 200, 20, value => {
            settings.viewDistance = value;
        }));
        this.buttonList.push(new GuiSwitchButton("Auto Sprint", settings.autoSprint, this.width / 2 - 100, y + 24 * 4, 200, 20, value => {
